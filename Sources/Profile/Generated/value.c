...
s8  val_PS3Vendor[17] = " ";
s8  val_PS3PtNumber[33] = " ";
s8  val_PS3SrNumber[9] = " ";
s8  val_PS4Vendor[17] = " ";
s8  val_PS4PtNumber[33] = " ";
s8  val_PS4SrNumber[9] = " ";
...
u8  col_OVLPCUMainRole[3] = {7,5,3};
u8  col_OVLPCURsrvRole[3] = {7,5,3};
u8  col_OVLPCPUMainState[3] = {7,5,3};
u8  col_OVLPMCUMainState[3] = {7,5,3};
u8  col_OVLPCPUReservState[3] = {7,5,3};
u8  col_OVLPMCUReservState[3] = {7,5,3};
...
u8  col_PS3Pres[3] = {7,5,3};
u8  col_PS3InPwrStatus[3] = {7,5,3};
u8  col_PS3OutPwrStatus[3] = {7,5,3};
u8  col_PS3OutCurrent[3] = {7,5,3};
u8  col_PS4Pres[3] = {7,5,3};
u8  col_PS4InPwrStatus[3] = {7,5,3};
u8  col_PS4OutPwrStatus[3] = {7,5,3};
u8  col_PS4OutCurrent[3] = {7,5,3};
...
f32 val_PS3CurrentK = 1;
f32 val_PS3CurrentB = 0;
f32 val_PS4CurrentK = 1;
f32 val_PS4CurrentB = 0;
...
f32 val_TCaseCMin = 0;
f32 val_V33VCMax = 3.7;
f32 val_V33VWMax = 3.5;
f32 val_V33VWMin = 3.15;
f32 val_V33VCMin = 3;
f32 val_V12VCMax = 13;
f32 val_V12VWMax = 12.5;
f32 val_V12VWMin = 11.5;
f32 val_V12VCMin = 11;
...
s8  val_CUNetCPUIPAddress[18] = "192.168.10.1";
s8  val_CUNetMCUIPAddress[18] = "192.168.10.2";
s8  val_CUNetIPMask[18] = "255.255.255.0";
s8  val_Compname[17] = " ";
s8  val_Compgroup[17] = " ";
