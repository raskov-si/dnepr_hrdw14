...
class File(object):
    ...
    def as_srec(self, size=32, address_length=32):
        ...
        if self.header:
            ...
            header = [pack_srec('0', 0, len(data), data)
    ...
    def cmd_cat(args):
        ...
        for file_args in file_args_list:
            ...
            if not file_args.output:
                ...
                if file_args.filename:
                    if file_args.type == 'srec':
                        data = file_all.as_srec(size=file_args.srec_length, address_length=file_args.address_length)
                    ...
                    if file_args.type == 'srec':
                        stdout.write(file_all.as_srec(size=file_args.srec_length, address_length=file_args.address_length))
                    elif file_args.type == 'ihex':
