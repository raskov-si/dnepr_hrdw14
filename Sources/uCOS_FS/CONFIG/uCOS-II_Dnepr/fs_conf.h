...
/*! \todo: _FS_CONF_H_ is defined somwhere else, find and fix it. */
#ifndef _FS_CONF_H_
#define _FS_CONF_H_
...
#define FS_USE_NMNX_M25P128_DRIVER 1 /* Dnepr M25P128 Flash IC */
...
*/
  ...
  */
	/*! \note Added for Dnepr: " + FS_USE_NMNX_M25P128_DRIVER" */
  #define FS_MAXDEV                 (FS_USE_SMC_DRIVER + FS_USE_WINDRIVE_DRIVER + FS_USE_RAMDISK_DRIVER + FS_USE_MMC_DRIVER + FS_USE_IDE_DRIVER + FS_USE_FLASH_DRIVER + FS_USE_NMNX_M25P128_DRIVER)
...
*/
  ...
  */
  #define FS_RR_BLOCKNUM      4        /* 32 -> 16KB RAM */
  /*
...
/* First parameter seems to be the name of logical volume for a given device */
#define FS_DEVINFO \
	"F", &FS__fat_functable, &FS__NMNX_M25P128_driver, 0

/*********************************************************************
*
*             NMNX_M25P128_DRIVER defines
*
  Defines for Flash memory used in Dnepr
*/
#if FS_USE_NMNX_M25P128_DRIVER
	#define FS_NMNX_M25P128_BLOCKNUM 512
