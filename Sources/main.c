...
int main(void)
{
    ...
    OSInit();  // делаем здесь, потому что драйверы уровн€ BSP могут иметь мьютексы (например FPGA)
    ...
    // остальные задачи создаютс€ внутри taskInit
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// задача, в которой инициализируютс€ остальные задачи
...
//	);
	...
	////////////////////////////////////////////////////////////////////////////
	// инициализируем переферию тут, чтобы работал таймер ќ— (дл€ таймаута в I2C)
	
	T8_Dnepr_TS_Init();
	// устанавливаем выводы и gpio
	DNEPR_PinsInit();
	/* »нициализаци€ программных модулей i2c, spi, mdio, свитчи, hotswap, eeprom backplane'а... */
