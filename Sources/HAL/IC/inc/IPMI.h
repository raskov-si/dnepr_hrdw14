...
//! максимальна€ длина строк, если на самом деле строка больше -- не читаем и ограничиваемс€ означенной длиной
...
//! „итает Common Header и затем Product Info заголовок раздела FRU.
_BOOL IPMI_Read_FRU_Headers( PMB_PeriphInterfaceTypedef *pmb_bus, u8 mAddr, IPMI_FRU* fru );
//! „итает Product Info Area.
...
//! ѕрошивает EEPROM в PSU в соответствии с fru.
