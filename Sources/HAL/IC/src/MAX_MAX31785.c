...
_BOOL MAX31785_SetPage(u8 mPage){
	...
	*/
	...
	PMB_PERIPH_INTERFACE_STRUCT_PTR->PMB_WriteByte(PMB_PERIPH_INTERFACE_STRUCT_PTR, __pmbus_addr, PMB_PAGE, mPage);
	return 1;
}
_BOOL MAX31785_GetPage(void){
	u8 res ;
	PMB_PERIPH_INTERFACE_STRUCT_PTR->PMB_ReadByte(PMB_PERIPH_INTERFACE_STRUCT_PTR, __pmbus_addr, PMB_PAGE, &res );
	return res ;
}
...
u8 __MAX31785_GetFanConfig12(u8 nPage){
	...
	PMB_PERIPH_INTERFACE_STRUCT_PTR->PMB_ReadByte(PMB_PERIPH_INTERFACE_STRUCT_PTR, __pmbus_addr, PMB_FAN_CONFIG_1_2, &res );
	return res ;
}
u16 __MAX31785_GetFanCommand1(u8 nPage){
	...
	assert( PMB_PERIPH_INTERFACE_STRUCT_PTR != NULL );
	MAX31785_SetPage(MAX31785_FAN_PWM_PAGE(nPage));
	PMB_PERIPH_INTERFACE_STRUCT_PTR->PMB_ReadWord(PMB_PERIPH_INTERFACE_STRUCT_PTR, __pmbus_addr, PMB_FAN_COMMAND_1, &res );
	return res ;
}
u8 __MAX31785_GetStatusFans12(u8 nPage){
	...
	assert( PMB_PERIPH_INTERFACE_STRUCT_PTR != NULL );
	MAX31785_SetPage(MAX31785_FAN_PWM_PAGE(nPage));
	PMB_PERIPH_INTERFACE_STRUCT_PTR->PMB_ReadByte(PMB_PERIPH_INTERFACE_STRUCT_PTR, __pmbus_addr, PMB_STATUS_FANS_1_2, &res );
	return res ;
}
_BOOL __MAX31785_SetFanConfig12(u8 nPage, u8 mCmd){
	assert( PMB_PERIPH_INTERFACE_STRUCT_PTR != NULL );
	MAX31785_SetPage(MAX31785_FAN_PWM_PAGE(nPage));
	return PMB_PERIPH_INTERFACE_STRUCT_PTR->PMB_WriteByte(PMB_PERIPH_INTERFACE_STRUCT_PTR, __pmbus_addr, PMB_FAN_CONFIG_1_2, mCmd);
}
_BOOL __MAX31785_SetFanCommand1(u8 nPage, u16 mCmd){
	assert( PMB_PERIPH_INTERFACE_STRUCT_PTR != NULL );
	MAX31785_SetPage(MAX31785_FAN_PWM_PAGE(nPage));
	return PMB_PERIPH_INTERFACE_STRUCT_PTR->PMB_WriteWord(PMB_PERIPH_INTERFACE_STRUCT_PTR, __pmbus_addr, PMB_FAN_COMMAND_1, mCmd);
}
u16 __MAX31785_GetMfrTempSensorConfig(u8 nPage){
	u16 res ;
	assert( PMB_PERIPH_INTERFACE_STRUCT_PTR != NULL );
	MAX31785_SetPage(nPage);
	PMB_PERIPH_INTERFACE_STRUCT_PTR->PMB_ReadWord(PMB_PERIPH_INTERFACE_STRUCT_PTR, __pmbus_addr, PMB_MFR_TEMP_SENSOR_CONFIG, &res );
	return res ;
}
_BOOL __MAX31785_SetMfrTempSensorConfig(u8 nPage, u16 mCmd){
	assert( PMB_PERIPH_INTERFACE_STRUCT_PTR != NULL );
	MAX31785_SetPage(nPage);
	return PMB_PERIPH_INTERFACE_STRUCT_PTR->PMB_WriteWord(PMB_PERIPH_INTERFACE_STRUCT_PTR, __pmbus_addr, PMB_MFR_TEMP_SENSOR_CONFIG, mCmd);
}
u16 __MAX31785_GetReadTemperature1(u8 nPage){
	u16 res ;
	assert( PMB_PERIPH_INTERFACE_STRUCT_PTR != NULL );
	MAX31785_SetPage(nPage);
	PMB_PERIPH_INTERFACE_STRUCT_PTR->PMB_ReadWord(PMB_PERIPH_INTERFACE_STRUCT_PTR, __pmbus_addr, PMB_READ_TEMPERATURE_1, &res );
	return res ;
}
_BOOL __MAX31785_GetMfrFanPwm2Rpm(u8 nPage, u16 *anValues){
	assert( PMB_PERIPH_INTERFACE_STRUCT_PTR != NULL );
	MAX31785_SetPage(nPage);
	PMB_PERIPH_INTERFACE_STRUCT_PTR->PMB_ReadMultipleWords(PMB_PERIPH_INTERFACE_STRUCT_PTR, __pmbus_addr, PMB_MFR_FAN_PWM2RPM, anValues, MAX31785_PWM2RPM_POINTS);
	return 1;
}
_BOOL __MAX31785_GetMfrFanLut(u8 nPage, u16 *anValues){
	assert( PMB_PERIPH_INTERFACE_STRUCT_PTR != NULL );
	MAX31785_SetPage(nPage);
	PMB_PERIPH_INTERFACE_STRUCT_PTR->PMB_ReadMultipleWords(PMB_PERIPH_INTERFACE_STRUCT_PTR, __pmbus_addr, PMB_MFR_FAN_LUT, anValues, MAX31785_LUT_POINTS*2);
	return 1;
}
_BOOL __MAX31785_SetMfrFanLut(u8 nPage, u16 *anValues){
	assert( PMB_PERIPH_INTERFACE_STRUCT_PTR != NULL );
	MAX31785_SetPage(nPage);
	return PMB_PERIPH_INTERFACE_STRUCT_PTR->PMB_WriteMultipleWords(PMB_PERIPH_INTERFACE_STRUCT_PTR, __pmbus_addr, PMB_MFR_FAN_LUT, anValues, MAX31785_LUT_POINTS*2);
}
_BOOL __MAX31785_SetMfrFanPwm2Rpm(u8 nPage, u16 *anValues){
	assert( PMB_PERIPH_INTERFACE_STRUCT_PTR != NULL );
	MAX31785_SetPage(nPage);
	return PMB_PERIPH_INTERFACE_STRUCT_PTR->PMB_WriteMultipleWords(PMB_PERIPH_INTERFACE_STRUCT_PTR, __pmbus_addr, PMB_MFR_FAN_PWM2RPM, anValues, MAX31785_PWM2RPM_POINTS);
}
u16 __MAX31785_GetReadFanSpeed1(u8 nPage){
	u16 res ;
	assert( PMB_PERIPH_INTERFACE_STRUCT_PTR != NULL );
	MAX31785_SetPage(nPage);
	PMB_PERIPH_INTERFACE_STRUCT_PTR->PMB_ReadWord(PMB_PERIPH_INTERFACE_STRUCT_PTR, __pmbus_addr, PMB_READ_FAN_SPEED_1, &res );
	return res ;
}
u16 __MAX31785_GetMfrReadFanPwm(u8 nPage){
	...
	assert( PMB_PERIPH_INTERFACE_STRUCT_PTR != NULL );
	MAX31785_SetPage(nPage);
	PMB_PERIPH_INTERFACE_STRUCT_PTR->PMB_ReadWord(PMB_PERIPH_INTERFACE_STRUCT_PTR, __pmbus_addr, PMB_MFR_READ_FAN_PWM, &res );
	return res ;
}
u16 __MAX31785_GetMfrFanRuntime(u8 nPage){
	...
	assert( PMB_PERIPH_INTERFACE_STRUCT_PTR != NULL );
	MAX31785_SetPage(nPage);
	PMB_PERIPH_INTERFACE_STRUCT_PTR->PMB_ReadWord(PMB_PERIPH_INTERFACE_STRUCT_PTR, __pmbus_addr, PMB_MFR_FAN_RUN_TIME, &res );
	return res ;
}
u16 __MAX31785_GetMfrFanPwmAvg(u8 nPage){
	...
	assert( PMB_PERIPH_INTERFACE_STRUCT_PTR != NULL );
	MAX31785_SetPage(nPage);
	PMB_PERIPH_INTERFACE_STRUCT_PTR->PMB_ReadWord(PMB_PERIPH_INTERFACE_STRUCT_PTR, __pmbus_addr, PMB_MFR_FAN_PWM_AVG, &res );
	return res ;
}
u16 __MAX31785_GetMfrFanConfig(u8 nPage){
	...
	assert( PMB_PERIPH_INTERFACE_STRUCT_PTR != NULL );
	MAX31785_SetPage(nPage);
	PMB_PERIPH_INTERFACE_STRUCT_PTR->PMB_ReadWord(PMB_PERIPH_INTERFACE_STRUCT_PTR, __pmbus_addr, PMB_MFR_FAN_CONFIG, &res );
	return res ;
}
_BOOL __MAX31785_SetMfrFanConfig(u8 nPage, u16 mCmd){
	assert( PMB_PERIPH_INTERFACE_STRUCT_PTR != NULL );
	MAX31785_SetPage(nPage);
	return PMB_PERIPH_INTERFACE_STRUCT_PTR->PMB_WriteWord(PMB_PERIPH_INTERFACE_STRUCT_PTR, __pmbus_addr, PMB_MFR_FAN_CONFIG, mCmd);
}
_BOOL __MAX31785_SetMfrFanFaultLimit(u8 nPage, u16 mCmd){
	assert( PMB_PERIPH_INTERFACE_STRUCT_PTR != NULL );
	MAX31785_SetPage(nPage);
	return PMB_PERIPH_INTERFACE_STRUCT_PTR->PMB_WriteWord(PMB_PERIPH_INTERFACE_STRUCT_PTR, __pmbus_addr, PMB_MFR_FAN_FAULT_LIMIT, mCmd);
}
...
u16 __MAX31785_GetMfrFanFaultLimit(u8 nPage){
	...
	assert( PMB_PERIPH_INTERFACE_STRUCT_PTR != NULL );
	MAX31785_SetPage(nPage);
	PMB_PERIPH_INTERFACE_STRUCT_PTR->PMB_ReadWord(PMB_PERIPH_INTERFACE_STRUCT_PTR, __pmbus_addr, PMB_MFR_FAN_FAULT_LIMIT, &res );
	return res ;
}
...
_BOOL __MAX31785_SetOtFaultLimit(u8 nPage, u16 mCmd){
	assert( PMB_PERIPH_INTERFACE_STRUCT_PTR != NULL );
	MAX31785_SetPage(nPage);
	return PMB_PERIPH_INTERFACE_STRUCT_PTR->PMB_WriteWord(PMB_PERIPH_INTERFACE_STRUCT_PTR, __pmbus_addr, PMB_OT_FAULT_LIMIT, mCmd);
}
...
u16 __MAX31785_GetOtFaultLimit(u8 nPage){
	...
	assert( PMB_PERIPH_INTERFACE_STRUCT_PTR != NULL );
	MAX31785_SetPage(nPage);
	PMB_PERIPH_INTERFACE_STRUCT_PTR->PMB_ReadWord(PMB_PERIPH_INTERFACE_STRUCT_PTR, __pmbus_addr, PMB_OT_FAULT_LIMIT, &res );
	return res ;
}
...
u8 __MAX31785_GetCapability(u8 nPage)
{
	...
	assert( PMB_PERIPH_INTERFACE_STRUCT_PTR != NULL );
	MAX31785_SetPage( nPage );
	PMB_PERIPH_INTERFACE_STRUCT_PTR->PMB_ReadByte(PMB_PERIPH_INTERFACE_STRUCT_PTR, __pmbus_addr, PMB_CAPABILITY, &res );
	return res ;
}
...
_BOOL MAX31785_SetMfrMode( const u8 mfr_mode_val )
{
	...
	assert( PMB_PERIPH_INTERFACE_STRUCT_PTR != NULL );
	MAX31785_SetPage( 22 );
	return PMB_PERIPH_INTERFACE_STRUCT_PTR->PMB_WriteWord( PMB_PERIPH_INTERFACE_STRUCT_PTR, __pmbus_addr, PMB_MFR_MODE, mfr_mode_val );
}
...
_BOOL MAX31785_GetStatusByte( u8 *res )
{
	assert( PMB_PERIPH_INTERFACE_STRUCT_PTR != NULL );
	assert( res != NULL );
	return PMB_PERIPH_INTERFACE_STRUCT_PTR->PMB_ReadByte(PMB_PERIPH_INTERFACE_STRUCT_PTR, __pmbus_addr, PMB_STATUS_BYTE, res );
}
...
_BOOL MAX31785_GetStatusWord( u16 *res )
{
	assert( PMB_PERIPH_INTERFACE_STRUCT_PTR != NULL );
	assert( res != NULL );
	return PMB_PERIPH_INTERFACE_STRUCT_PTR->PMB_ReadWord(PMB_PERIPH_INTERFACE_STRUCT_PTR, __pmbus_addr, PMB_STATUS_WORD, res );
}
...
_BOOL MAX31785_GetStatusCML( u8* res )
{
	assert( PMB_PERIPH_INTERFACE_STRUCT_PTR != NULL );
	assert( res != NULL );
	return PMB_PERIPH_INTERFACE_STRUCT_PTR->PMB_ReadByte(PMB_PERIPH_INTERFACE_STRUCT_PTR, __pmbus_addr, PMB_STATUS_CML, res );
}
...
_BOOL MAX31785_GetMfrSpecific( u8* res )
{
	assert( PMB_PERIPH_INTERFACE_STRUCT_PTR != NULL );
	assert( res != NULL );
	return PMB_PERIPH_INTERFACE_STRUCT_PTR->PMB_ReadByte(PMB_PERIPH_INTERFACE_STRUCT_PTR, __pmbus_addr, PMB_STATUS_MFR_SPECIFIC, res );	
}
...
_BOOL __MAX31785_StoreDefaultAll(){
	...
	*/
	assert( PMB_PERIPH_INTERFACE_STRUCT_PTR != NULL );
	return PMB_PERIPH_INTERFACE_STRUCT_PTR->PMB_SendCommand(PMB_PERIPH_INTERFACE_STRUCT_PTR, __pmbus_addr, PMB_STORE_DEFAULT_ALL);
}
_BOOL __MAX31785_RestoreDefaultAll(){
	...
	*/
	assert( PMB_PERIPH_INTERFACE_STRUCT_PTR != NULL );
	return PMB_PERIPH_INTERFACE_STRUCT_PTR->PMB_SendCommand(PMB_PERIPH_INTERFACE_STRUCT_PTR, __pmbus_addr, PMB_RESTORE_DEFAULT_ALL);
}
...
_BOOL __MAX31785_ClearFaults(){
	...
	*/
	assert( PMB_PERIPH_INTERFACE_STRUCT_PTR != NULL );
	return PMB_PERIPH_INTERFACE_STRUCT_PTR->PMB_SendCommand( PMB_PERIPH_INTERFACE_STRUCT_PTR, __pmbus_addr, PMB_CLEAR_FAULTS );
}
...
_BOOL MAX31785_ReadFanRPM( u16 *res )
{
	...
	*/
	...
	ret = PMB_PERIPH_INTERFACE_STRUCT_PTR->PMB_ReadWord(PMB_PERIPH_INTERFACE_STRUCT_PTR, __pmbus_addr, PMB_READ_FAN_SPEED_1, &rpm );
