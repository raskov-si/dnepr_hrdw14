...
_BOOL TI_UCD9080_FetchError( TI_UCD9080_ErrorData* tError){
    ...
    */
    ...
    if(!I2C_PERIPH_INTERFACE_STRUCT_PTR->I2C_ReadMultipleBytes( I2C_PERIPH_INTERFACE_STRUCT_PTR, _mAddress, TI_UCD9080_ERROR_BASE(1), nErrorRegisterTmp, TI_UCD9080_ERROR_REGISTER_LENGTH)) return 0;
...
_BOOL TI_UCD9080_GetStatus( TI_UCD9080_Status* tStatus){
    ...
    */
    ...
    ret = I2C_PERIPH_INTERFACE_STRUCT_PTR->I2C_ReadByte( I2C_PERIPH_INTERFACE_STRUCT_PTR, _mAddress, TI_UCD9080_STATUS, &nStatusTmp );
...
u8 TI_UCD9080_GetVersion(){
    ...
    */
    ...
    I2C_PERIPH_INTERFACE_STRUCT_PTR->I2C_ReadByte( I2C_PERIPH_INTERFACE_STRUCT_PTR, _mAddress, TI_UCD9080_VERSION, &nVersionTmp);
...
_BOOL TI_UCD9080_Restart(){
    ...
    */
    ...
    return I2C_PERIPH_INTERFACE_STRUCT_PTR->I2C_WriteByte( I2C_PERIPH_INTERFACE_STRUCT_PTR, _mAddress, TI_UCD9080_RESTART, TI_UCD9080_RESTART_COMMAND);    
}
...
_BOOL TI_UCD9080_ReadUserData( u8* anData, u32 nSize){
    ...
    */
    ...
    for(i=0; i<nSize; i+=2){
		I2C_PERIPH_INTERFACE_STRUCT_PTR->I2C_WriteWord( I2C_PERIPH_INTERFACE_STRUCT_PTR, _mAddress, TI_UCD9080_WADDR1, TI_UCD9080_USER_DATA_ADDR(i));
...
_BOOL TI_UCD9080_WriteUserData( u8 const* anData, u32 nSize){
    ...
    */
	...
	I2C_PERIPH_INTERFACE_STRUCT_PTR->I2C_WriteWord( I2C_PERIPH_INTERFACE_STRUCT_PTR, _mAddress, TI_UCD9080_WADDR1, TI_UCD9080_USER_DATA_ADDR(0));
    I2C_PERIPH_INTERFACE_STRUCT_PTR->I2C_WriteWord( I2C_PERIPH_INTERFACE_STRUCT_PTR, _mAddress, TI_UCD9080_WDATA1, TI_UCD9080_MEMORY_UPDATE_CMD);    
    
    for(i=0; i<nSize; i+=2){       
		nWordTmp = _WORD(anData[i], anData[i+1]);
		I2C_PERIPH_INTERFACE_STRUCT_PTR->I2C_WriteWord( I2C_PERIPH_INTERFACE_STRUCT_PTR, _mAddress, TI_UCD9080_WADDR1, TI_UCD9080_USER_DATA_ADDR(i));    
        I2C_PERIPH_INTERFACE_STRUCT_PTR->I2C_WriteWord( I2C_PERIPH_INTERFACE_STRUCT_PTR, _mAddress, TI_UCD9080_WDATA1, nWordTmp);          
	}
...
_BOOL TI_UCD9080_WriteConfig( u8 const* anData, u32 nSize){
    ...
    */
    ...
    TI_UCD9080_FlashlockCmd( TI_UCD9080_FlashlockUnlock );
	I2C_PERIPH_INTERFACE_STRUCT_PTR->I2C_WriteWord( I2C_PERIPH_INTERFACE_STRUCT_PTR, _mAddress, TI_UCD9080_WADDR1, TI_UCD9080_CONFIG_ADDR(0));
    I2C_PERIPH_INTERFACE_STRUCT_PTR->I2C_WriteWord( I2C_PERIPH_INTERFACE_STRUCT_PTR, _mAddress, TI_UCD9080_WDATA1, TI_UCD9080_MEMORY_UPDATE_CMD);    
    
    for(i=0; i<nSize; i+=2){
        nWordTmp = _WORD(anData[i], anData[i+1]);
        I2C_PERIPH_INTERFACE_STRUCT_PTR->I2C_WriteWord( I2C_PERIPH_INTERFACE_STRUCT_PTR, _mAddress, TI_UCD9080_WADDR1, swap_word(swap_word(TI_UCD9080_CONFIG_ADDR_BASE) + i));
        I2C_PERIPH_INTERFACE_STRUCT_PTR->I2C_WriteWord( I2C_PERIPH_INTERFACE_STRUCT_PTR, _mAddress, TI_UCD9080_WDATA1, nWordTmp);
    }
...
static _BOOL TI_UCD9080_FlashlockCmd( TI_UCD9080_FlashlockValue mFlashlockValue){
    ...
    */
    ...
    return I2C_PERIPH_INTERFACE_STRUCT_PTR->I2C_WriteByte( I2C_PERIPH_INTERFACE_STRUCT_PTR, _mAddress, TI_UCD9080_FLASHLOCK, (u8)mFlashlockValue);    
}
...
//    TI_UCD9080_FlashlockCmd(mAddress, TI_UCD9080_FlashlockLock);
    ...
    I2C_PERIPH_INTERFACE_STRUCT_PTR->I2C_WriteByte( I2C_PERIPH_INTERFACE_STRUCT_PTR, _mAddress, TI_UCD9080_FLASHLOCK, 0x02);
    OSTimeDly( 3 );

    I2C_PERIPH_INTERFACE_STRUCT_PTR->I2C_WriteByte( I2C_PERIPH_INTERFACE_STRUCT_PTR, _mAddress, TI_UCD9080_WADDR1, 0x00);
    OSTimeDly( 3 );
    I2C_PERIPH_INTERFACE_STRUCT_PTR->I2C_WriteByte( I2C_PERIPH_INTERFACE_STRUCT_PTR, _mAddress, TI_UCD9080_WADDR2, 0x00);
    OSTimeDly( 3 );
    I2C_PERIPH_INTERFACE_STRUCT_PTR->I2C_WriteByte( I2C_PERIPH_INTERFACE_STRUCT_PTR, _mAddress, TI_UCD9080_WDATA1, 0xdc);
    OSTimeDly( 3 );
    I2C_PERIPH_INTERFACE_STRUCT_PTR->I2C_WriteByte( I2C_PERIPH_INTERFACE_STRUCT_PTR, _mAddress, TI_UCD9080_WDATA2, 0xba);
    OSTimeDly( 3 );

    I2C_PERIPH_INTERFACE_STRUCT_PTR->I2C_WriteByte( I2C_PERIPH_INTERFACE_STRUCT_PTR, _mAddress, TI_UCD9080_WADDR1, 0x01);
    OSTimeDly( 3 );
    I2C_PERIPH_INTERFACE_STRUCT_PTR->I2C_WriteByte( I2C_PERIPH_INTERFACE_STRUCT_PTR, _mAddress, TI_UCD9080_WADDR2, 0x00);
    OSTimeDly( 3 );
    I2C_PERIPH_INTERFACE_STRUCT_PTR->I2C_WriteByte( I2C_PERIPH_INTERFACE_STRUCT_PTR, _mAddress, TI_UCD9080_WDATA1, 0xdc);
    ...
    I2C_PERIPH_INTERFACE_STRUCT_PTR->I2C_WriteByte( I2C_PERIPH_INTERFACE_STRUCT_PTR, _mAddress, TI_UCD9080_FLASHLOCK, 0x00);
    OSTimeDly( 3 );
