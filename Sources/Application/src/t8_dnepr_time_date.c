...
clock_t clock(void)
{
    ...
    clock_value *= 2;           ////WTF иначе интервалы времени считаютс€ в 2 раза меньше, вы€снить что это
...
/*
===================================================================================================
Description: ”становка начального времени таймера
Returns    : 
Notes      : —лужба поддержки таймеров в автоматах
===================================================================================================
*/
void timer_reset
(
...
/*
===================================================================================================
Description: проверка истечени€ таймера, сохраненного функцией timer_set
